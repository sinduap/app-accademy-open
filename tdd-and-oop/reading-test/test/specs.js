...
describe('isFive(num)', () => {
  // Test whether isFive(num) return true if num is 5, otherwise false
...
describe('isOdd(number)', () => {
  // Test isOdd(number) return true if number is odd
  ...
  it('should return false if the num is even', () => {
    // Test isOdd(number) return true if number is even
    const num1 = 4;
    const num2 = 2952;
    const num3 = -998;
  ...
  it('should throw an error if num is not type of Number', () => {
    // Test isOdd(number) thow an error if number is not type of Number
...
describe('myRange(min, max, step)', () => {
  // Test context: step argument is not provided
  context('if step is not provided', () => {
    // Test myRange(min, max) return correct array with default value step = 1
  ...
  // Test context: step argument is provided
  context('if step is provided', () => {
    // Test myRange(min, max) return correct array
